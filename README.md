...
- `correlate-image`: [Correlate images](src/commands/deployment/) from CD providers with their source commit. [📚](https://docs.datadoghq.com/continuous_delivery/deployments/argocd#correlate-images-with-source-codeL)
