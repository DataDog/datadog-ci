...
export class LambdaFlareCommand extends Command {
  ...
  public async execute() {
    ...
    try {
      ...
      generateInfoFile(infoFilePath, framework)
 ...
 */
export const generateInfoFile = (infoFilePath: string, framework: string) => {
  // TODO write tests, get full command ran, get framework
  const lines: string[] = []
