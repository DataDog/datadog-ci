...
export const AttachedText = {
  ...
  create<I extends Exact<DeepPartial<AttachedText>, I>>(base?: I): AttachedText {
    return AttachedText.fromPartial(base ?? {});
  },
...
export const Bom : CustomMessage<Bom> = {
  ...
  toJSON(message: Bom): unknown {
    ...
    if (message.externalReferences) {
      obj.externalReferences = message.externalReferences.map((e) => e ? ExternalReference.toJSON(e) : undefined);
    } else {
      obj.externalReferences = [];
    }
    ...
    if (message.compositions) {
      obj.compositions = message.compositions.map((e) => e ? Composition.toJSON(e) : undefined);
    } else {
      obj.compositions = [];
    }
...
export const Commit = {
  ...
  toJSON(message: Commit): unknown {
    ...
    message.author !== undefined &&
      (obj.author = message.author ? IdentifiableAction.toJSON(message.author) : undefined);
    message.committer !== undefined &&
      (obj.committer = message.committer ? IdentifiableAction.toJSON(message.committer) : undefined);
...
export const Component : CustomMessage<Component> = {
  ...
  toJSON(message: Component): unknown {
    ...
    message.scope !== undefined && (obj.scope = message.scope !== undefined ? scopeToJSON(message.scope) : undefined);
    if (message.hashes) {
      obj.hashes = message.hashes.map((e) => e ? Hash.toJSON(e) : undefined);
    } else {
      obj.hashes = [];
    }
    if (message.licenses) {
      obj.licenses = message.licenses.map((e) => e ? LicenseChoice.toJSON(e) : undefined);
    } else {
      obj.licenses = [];
    }
    message.copyright !== undefined && (obj.copyright = message.copyright);
    message.cpe !== undefined && (obj.cpe = message.cpe);
    message.purl !== undefined && (obj.purl = message.purl);
    message.swid !== undefined && (obj.swid = message.swid ? Swid.toJSON(message.swid) : undefined);
    message.modified !== undefined && (obj.modified = message.modified);
    message.pedigree !== undefined && (obj.pedigree = message.pedigree ? Pedigree.toJSON(message.pedigree) : undefined);
    if (message.externalReferences) {
      obj.externalReferences = message.externalReferences.map((e) => e ? ExternalReference.toJSON(e) : undefined);
    } else {
      obj.externalReferences = [];
    ...
    message.releaseNotes !== undefined &&
      (obj.releaseNotes = message.releaseNotes ? ReleaseNotes.toJSON(message.releaseNotes) : undefined);
    return obj;
  },
...
export const DataClassification = {
  ...
  create<I extends Exact<DeepPartial<DataClassification>, I>>(base?: I): DataClassification {
    return DataClassification.fromPartial(base ?? {});
  },
...
export const Diff = {
  ...
  toJSON(message: Diff): unknown {
    const obj: any = {};
    message.text !== undefined && (obj.text = message.text ? AttachedText.toJSON(message.text) : undefined);
    message.url !== undefined && (obj.url = message.url);
    return obj;
  },
...
export const ExternalReference = {
  ...
  toJSON(message: ExternalReference): unknown {
    const obj: any = {};
    message.type !== undefined && (obj.type = externalReferenceTypeToJSON(message.type));
    message.url !== undefined && (obj.url = message.url);
  ...
  create<I extends Exact<DeepPartial<ExternalReference>, I>>(base?: I): ExternalReference {
    return ExternalReference.fromPartial(base ?? {});
  },
...
export const IdentifiableAction = {
  ...
  create<I extends Exact<DeepPartial<IdentifiableAction>, I>>(base?: I): IdentifiableAction {
    return IdentifiableAction.fromPartial(base ?? {});
  },
...
export const Issue = {
  ...
  toJSON(message: Issue): unknown {
    const obj: any = {};
    message.type !== undefined && (obj.type = issueClassificationToJSON(message.type));
    message.id !== undefined && (obj.id = message.id);
    message.name !== undefined && (obj.name = message.name);
    message.description !== undefined && (obj.description = message.description);
    message.source !== undefined && (obj.source = message.source ? Source.toJSON(message.source) : undefined);
    if (message.references) {
      obj.references = message.references.map((e) => e);
    } else {
      obj.references = [];
    }
    return obj;
...
export const LicenseChoice = {
  ...
  create<I extends Exact<DeepPartial<LicenseChoice>, I>>(base?: I): LicenseChoice {
    return LicenseChoice.fromPartial(base ?? {});
  },
...
export const Metadata : CustomMessage<Metadata> = {
  ...
  toJSON(message: Metadata): unknown {
    ...
    if (message.authors) {
      obj.authors = message.authors.map((e) => e ? OrganizationalContact.toJSON(e) : undefined);
    } else {
      obj.authors = [];
    }
    message.component !== undefined &&
      (obj.component = message.component ? Component.toJSON(message.component) : undefined);
    message.manufacture !== undefined &&
      (obj.manufacture = message.manufacture ? OrganizationalEntity.toJSON(message.manufacture) : undefined);
    message.supplier !== undefined &&
      (obj.supplier = message.supplier ? OrganizationalEntity.toJSON(message.supplier) : undefined);
    message.licenses !== undefined &&
      (obj.licenses = message.licenses ? LicenseChoice.toJSON(message.licenses) : undefined);
    if (message.properties) {
      obj.properties = message.properties.map((e) => e ? Property.toJSON(e) : undefined);
    } else {
      obj.properties = [];
  ...
  fromPartial<I extends Exact<DeepPartial<Metadata>, I>>(object: I): Metadata {
    ...
    message.supplier = (object.supplier !== undefined && object.supplier !== null)
      ? OrganizationalEntity.fromPartial(object.supplier)
      : undefined;
    message.licenses = (object.licenses !== undefined && object.licenses !== null)
      ? LicenseChoice.fromPartial(object.licenses)
      : undefined;
    message.properties = object.properties?.map((e) => Property.fromPartial(e)) || [];
    return message;
  },
...
export const OrganizationalContact = {
  ...
  create<I extends Exact<DeepPartial<OrganizationalContact>, I>>(base?: I): OrganizationalContact {
    return OrganizationalContact.fromPartial(base ?? {});
  },
...
export const OrganizationalEntity = {
  ...
  toJSON(message: OrganizationalEntity): unknown {
    ...
    if (message.contact) {
      obj.contact = message.contact.map((e) => e ? OrganizationalContact.toJSON(e) : undefined);
    } else {
      obj.contact = [];
    }
    return obj;
  ...
  create<I extends Exact<DeepPartial<OrganizationalEntity>, I>>(base?: I): OrganizationalEntity {
    return OrganizationalEntity.fromPartial(base ?? {});
  },
...
export const Patch = {
  ...
  toJSON(message: Patch): unknown {
    const obj: any = {};
    message.type !== undefined && (obj.type = patchClassificationToJSON(message.type));
    message.diff !== undefined && (obj.diff = message.diff ? Diff.toJSON(message.diff) : undefined);
    if (message.resolves) {
      obj.resolves = message.resolves.map((e) => e ? Issue.toJSON(e) : undefined);
    } else {
      obj.resolves = [];
    }
    return obj;
...
export const Pedigree : CustomMessage<Pedigree> = {
  ...
  toJSON(message: Pedigree): unknown {
    ...
    if (message.ancestors) {
      obj.ancestors = message.ancestors.map((e) => e ? Component.toJSON(e) : undefined);
    } else {
      obj.ancestors = [];
    }
    if (message.descendants) {
      obj.descendants = message.descendants.map((e) => e ? Component.toJSON(e) : undefined);
    } else {
      obj.descendants = [];
    }
    if (message.variants) {
      obj.variants = message.variants.map((e) => e ? Component.toJSON(e) : undefined);
    } else {
      obj.variants = [];
    }
    if (message.commits) {
    ...
    if (message.patches) {
      obj.patches = message.patches.map((e) => e ? Patch.toJSON(e) : undefined);
    } else {
      obj.patches = [];
    }
  ...
  create<I extends Exact<DeepPartial<Pedigree>, I>>(base?: I): Pedigree {
    return Pedigree.fromPartial(base ?? {});
  },
...
export const Swid = {
  ...
  toJSON(message: Swid): unknown {
    ...
    message.name !== undefined && (obj.name = message.name);
    message.version !== undefined && (obj.version = message.version);
    message.tagVersion !== undefined && (obj.tagVersion = Math.round(message.tagVersion));
...
export const Composition = {
  ...
  toJSON(message: Composition): unknown {
    const obj: any = {};
    message.aggregate !== undefined && (obj.aggregate = aggregateToJSON(message.aggregate));
    if (message.assemblies) {
      obj.assemblies = message.assemblies.map((e) => e);
    } else {
      obj.assemblies = [];
    }
    if (message.dependencies) {
  ...
  create<I extends Exact<DeepPartial<Composition>, I>>(base?: I): Composition {
    return Composition.fromPartial(base ?? {});
  },
...
export const EvidenceCopyright = {
  ...
  create<I extends Exact<DeepPartial<EvidenceCopyright>, I>>(base?: I): EvidenceCopyright {
    return EvidenceCopyright.fromPartial(base ?? {});
  },
...
export const Evidence = {
  ...
  toJSON(message: Evidence): unknown {
    ...
    if (message.copyright) {
      obj.copyright = message.copyright.map((e) => e ? EvidenceCopyright.toJSON(e) : undefined);
    } else {
      obj.copyright = [];
    }
    return obj;
...
export const ReleaseNotes = {
  ...
  toJSON(message: ReleaseNotes): unknown {
    ...
    message.socialImage !== undefined && (obj.socialImage = message.socialImage);
    message.description !== undefined && (obj.description = message.description);
    message.timestamp !== undefined && (obj.timestamp = message.timestamp.toISOString());
    if (message.aliases) {
  ...
  create<I extends Exact<DeepPartial<ReleaseNotes>, I>>(base?: I): ReleaseNotes {
    return ReleaseNotes.fromPartial(base ?? {});
  },
...
export const Vulnerability = {
  ...
  toJSON(message: Vulnerability): unknown {
    ...
    message.source !== undefined && (obj.source = message.source ? Source.toJSON(message.source) : undefined);
    if (message.references) {
      obj.references = message.references.map((e) => e ? VulnerabilityReference.toJSON(e) : undefined);
    } else {
      obj.references = [];
    }
    if (message.ratings) {
      obj.ratings = message.ratings.map((e) => e ? VulnerabilityRating.toJSON(e) : undefined);
    } else {
      obj.ratings = [];
    }
    if (message.cwes) {
    ...
    if (message.advisories) {
      obj.advisories = message.advisories.map((e) => e ? Advisory.toJSON(e) : undefined);
    } else {
      obj.advisories = [];
    }
    ...
    message.credits !== undefined &&
      (obj.credits = message.credits ? VulnerabilityCredits.toJSON(message.credits) : undefined);
    if (message.tools) {
      obj.tools = message.tools.map((e) => e ? Tool.toJSON(e) : undefined);
    } else {
      obj.tools = [];
    ...
    message.analysis !== undefined &&
      (obj.analysis = message.analysis ? VulnerabilityAnalysis.toJSON(message.analysis) : undefined);
    if (message.affects) {
      obj.affects = message.affects.map((e) => e ? VulnerabilityAffects.toJSON(e) : undefined);
    } else {
      obj.affects = [];
    }
    if (message.properties) {
...
export const VulnerabilityReference = {
  ...
  create<I extends Exact<DeepPartial<VulnerabilityReference>, I>>(base?: I): VulnerabilityReference {
    return VulnerabilityReference.fromPartial(base ?? {});
  },
...
export const VulnerabilityRating = {
  ...
  toJSON(message: VulnerabilityRating): unknown {
    ...
    message.severity !== undefined &&
      (obj.severity = message.severity !== undefined ? severityToJSON(message.severity) : undefined);
    message.method !== undefined &&
      (obj.method = message.method !== undefined ? scoreMethodToJSON(message.method) : undefined);
    message.vector !== undefined && (obj.vector = message.vector);
    message.justification !== undefined && (obj.justification = message.justification);
    return obj;
  },

  create<I extends Exact<DeepPartial<VulnerabilityRating>, I>>(base?: I): VulnerabilityRating {
    return VulnerabilityRating.fromPartial(base ?? {});
  },
...
export const VulnerabilityCredits = {
  ...
  toJSON(message: VulnerabilityCredits): unknown {
    ...
    if (message.organizations) {
      obj.organizations = message.organizations.map((e) => e ? OrganizationalEntity.toJSON(e) : undefined);
    } else {
      obj.organizations = [];
    }
    if (message.individuals) {
      obj.individuals = message.individuals.map((e) => e ? OrganizationalContact.toJSON(e) : undefined);
    } else {
      obj.individuals = [];
    }
    return obj;
  ...
  create<I extends Exact<DeepPartial<VulnerabilityCredits>, I>>(base?: I): VulnerabilityCredits {
    return VulnerabilityCredits.fromPartial(base ?? {});
  },
...
export const VulnerabilityAnalysis = {
  ...
  toJSON(message: VulnerabilityAnalysis): unknown {
    ...
    message.state !== undefined &&
      (obj.state = message.state !== undefined ? impactAnalysisStateToJSON(message.state) : undefined);
    message.justification !== undefined && (obj.justification = message.justification !== undefined
      ? impactAnalysisJustificationToJSON(message.justification)
      : undefined);
    if (message.response) {
  ...
  create<I extends Exact<DeepPartial<VulnerabilityAnalysis>, I>>(base?: I): VulnerabilityAnalysis {
    return VulnerabilityAnalysis.fromPartial(base ?? {});
  },
...
export const VulnerabilityAffects = {
  ...
  toJSON(message: VulnerabilityAffects): unknown {
    ...
    message.ref !== undefined && (obj.ref = message.ref);
    if (message.versions) {
      obj.versions = message.versions.map((e) => e ? VulnerabilityAffectedVersions.toJSON(e) : undefined);
    } else {
      obj.versions = [];
    }
    return obj;
  ...
  create<I extends Exact<DeepPartial<VulnerabilityAffects>, I>>(base?: I): VulnerabilityAffects {
    return VulnerabilityAffects.fromPartial(base ?? {});
  },
...
export const VulnerabilityAffectedVersions = {
  ...
  toJSON(message: VulnerabilityAffectedVersions): unknown {
    ...
    message.status !== undefined &&
      (obj.status = message.status !== undefined ? vulnerabilityAffectedStatusToJSON(message.status) : undefined);
    return obj;
  },

  create<I extends Exact<DeepPartial<VulnerabilityAffectedVersions>, I>>(base?: I): VulnerabilityAffectedVersions {
    return VulnerabilityAffectedVersions.fromPartial(base ?? {});
  },
