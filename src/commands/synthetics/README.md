...
| `pollingTimeout`<a id='polling-timeout'></a>                   | Integer          | The maximum duration in milliseconds of a test. If the execution exceeds this value, it is considered failed.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
