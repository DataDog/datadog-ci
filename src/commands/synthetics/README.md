...
| `mobileApplicationVersion`         | String           | Override the default mobile application version to test a different version within Datadog. The version must be uploaded and available within Datadog.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
