...
| `pollingTimeout`                   | Integer          | The maximum duration in milliseconds of a test. If the execution exceeds this value, it is considered failed. The maximum accepted is 7 200 000 for 2h.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
