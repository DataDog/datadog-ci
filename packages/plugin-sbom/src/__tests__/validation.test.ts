...
describe('validation of sbom file', () => {
  test('should succeed when called on a valid CycloneDX 1.4 SBOM file', () => {
    expect(validateSbomFileAgainstSchema('./src/__tests__/fixtures/sbom.1.4.ok.json', validator, false)).toBeTruthy()
    expect(validateFileAgainstToolRequirements('./src/__tests__/fixtures/sbom.1.5.ok.json', false)).toBeTruthy()
  })
  ...
  test('should succeed when called on a valid CycloneDX 1.5 SBOM file', () => {
    expect(validateSbomFileAgainstSchema('./src/__tests__/fixtures/sbom.1.5.ok.json', validator, false)).toBeTruthy()
    expect(validateFileAgainstToolRequirements('./src/__tests__/fixtures/sbom.1.5.ok.json', false)).toBeTruthy()
  })
  ...
  test('should fail on files that do not exist', () => {
    ...
    expect(validateFileAgainstToolRequirements('./src/__tests__/fixtures/sbom.1.4.do.not.exists', false)).toBeFalsy()
  })
  ...
  test('should validate SBOM file from trivy 4.9', () => {
    ...
    expect(validateFileAgainstToolRequirements('./src/__tests__/fixtures/trivy-4.9.json', true)).toBeTruthy()
  })
  ...
  test('should validate SBOM file osv scanner - version 1.5', () => {
    ...
    expect(validateFileAgainstToolRequirements('./src/__tests__/fixtures/osv-scanner-files.json', true)).toBeTruthy()
  })

  test('SBOM with no components is valid', () => {
    expect(validateFileAgainstToolRequirements('./src/__tests__/fixtures/sbom-no-components.json', true)).toBeTruthy()
  })

  test('does not validate random data', () => {
    expect(validateSbomFileAgainstSchema('./src/__tests__/fixtures/random-data', validator, true)).toBeFalsy()
