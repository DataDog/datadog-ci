...
| `DD_SITE`            | Set which Datadog site to send data. Possible values are `datadoghq.com`, `datadoghq.eu`, `us3.datadoghq.com`, `us5.datadoghq.com`, `ap1.datadoghq.com`, `ap2.datadoghq.com`, `ddog-gov.com`, and `prtest07.datadoghq.com`. The default is `datadoghq.com`. | `export DD_SITE=datadoghq.com` |
