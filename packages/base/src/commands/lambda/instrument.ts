...
export class LambdaInstrumentCommand extends BaseCommand {
  ...
  protected layerVersion = Option.String('-v,--layer-version,--layerVersion', {
    description: `Version of the Datadog Lambda Library layer to apply. Defaults to 'latest'. The 'latest' value uses the recommended version for the function runtime. Setting to 'none' will disable adding the language layer.`,
  })
