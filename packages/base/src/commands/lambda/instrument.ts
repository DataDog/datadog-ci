...
import {LAMBDA_LAYER_CATALOG} from '../../helpers/serverless/lambda-layer-catalog'

import {BaseCommand} from '../..'

const LAYER_VERSIONS_HELP_STRING = Object.entries(LAMBDA_LAYER_CATALOG.versions)
...
export class LambdaInstrumentCommand extends BaseCommand {
  ...
  protected extensionVersion = Option.String('-e,--extension-version,--extensionVersion', {
    description: `Version of the Datadog Lambda Extension layer to apply. Defaults to 'latest'. Setting this to 'latest' will use version ${LAMBDA_LAYER_CATALOG.versions.extension}. When using the extension, make sure to export DATADOG_API_KEY (or if encrypted, DATADOG_KMS_API_KEY or DATADOG_API_KEY_SECRET_ARN) in your environment as well. Mutually exclusive with the forwarder. Set to 'none' to explicitly disable adding the extension layer. Learn more about the Lambda Extension here: https://docs.datadoghq.com/serverless/libraries_integrations/extension`,
  })
