...
| `--layer-version` or `--layerVersion` | `-v` | Version of the Datadog Lambda Library layer to apply. Setting this to 'latest' will use one of the following versions based on your runtime: dotnet - 25, java - 27, node - 143, python - 127, ruby - 30. Setting to 'none' will disable adding the language layer. | `latest` |
