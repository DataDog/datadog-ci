...
| `--layer-version` or `--layerVersion` | `-v` | Version of the Datadog Lambda Library layer to apply. The 'latest' value uses the recommended version for the function runtime. Setting to 'none' will disable adding the language layer. | `latest` |
