...
export const calculateUpdateRequest = async (
  ...
  if (site !== undefined && oldEnvVars[SITE_ENV_VAR] !== site) {
    if (isValidDatadogSite(site)) {
      ...
      throw new Error(
        'Warning: Invalid site URL. Must be either datadoghq.com, datadoghq.eu, us3.datadoghq.com, us5.datadoghq.com, ap1.datadoghq.com, ap2.datadoghq.com, ddog-gov.com, or us2.ddog-gov.com.'
      )
    }
  }
