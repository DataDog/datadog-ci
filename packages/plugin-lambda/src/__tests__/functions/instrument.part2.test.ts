  ...
  describe('calculateUpdateRequest', () => {
    ...
    test('throws an error when an invalid DATADOG_SITE url is given', async () => {
      ...
      expect(error?.message).toBe(
        'Warning: Invalid site URL. Must be either datadoghq.com, datadoghq.eu, us3.datadoghq.com, us5.datadoghq.com, ap1.datadoghq.com, ap2.datadoghq.com, uk1.datadoghq.com, ddog-gov.com, or us2.ddog-gov.com.'
      )
    })
