...
| `--build-id`                 | Optional  | Build ID for Android mapping upload. When provided, overrides the requirement for `--service-name`, `--version`, and `--flavor` for Android mapping files.                                                                                                                                                      |
